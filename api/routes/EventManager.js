...
router.put("/update", verify, async (req, res) => {
  try {
    ...
    if (req.body.ownerFirstName)
      eventManager.ownerFirstName = req.body.ownerFirstName;
    if (req.body.ownerLastName)
      eventManager.ownerLastName = req.body.ownerLastName;
    ...
    if (req.body.whatsappBusinessNumber)
      eventManager.whatsappBusinessNumber = req.body.whatsappBusinessNumber;
    if (req.body.fbPageUrl) eventManager.fbPageUrl = req.body.fbPageUrl;
    if (req.body.instagramPageUrl)
      eventManager.instagramPageUrl = req.body.compainstagramPageUrlnyName;
    if (req.body.linkedinPageUrl)
      eventManager.linkedinPageUrl = req.body.linkedinPageUrl;
    if (req.body.twitterPageUrl)
      eventManager.twitterPageUrl = req.body.twitterPageUrl;
    if (req.body.youtubePageUrl)
      eventManager.youtubePageUrl = req.body.youtubePageUrl;
